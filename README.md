...
![Project 2](https://img.shields.io/badge/Project-2-green) 📌 *API-REST-dice-roll-Laravel-8:* REST API for an online dice game, with passport authentication, permissions and testing in Laravel 8
